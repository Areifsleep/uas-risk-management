        ...
        <>
            ...
            <main className="w-full h-full min-h-screen">
                <div className="max-w-[1400px] mx-auto space-y-10">
                    <div className="bg-muted rounded-sm flex justify-center items-center">
                    ...
                    <div id="contributors">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 lg:grid-cols-4 my-10">
...
//                 />
//                 <div className="relative text-md leading-relaxedn-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
